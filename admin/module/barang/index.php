              ...
              <div class="row">
                  <div class="col-lg-12 main-chart">
						...
						<a href="index.php?page=barang&stok=yes" style="margin-right :0.5pc;" 
							...
							<i class="fa fa-list"></i> Sortir Jumlah Kurang</a>
						...
						<div id="myModal" class="modal fade" role="dialog">
							<div class="modal-dialog">
								...
								<div class="modal-header" style="background:#285c64;color:#fff;">
									...
									<h4 class="modal-title"><i class="fa fa-plus"></i> Tambah Customer</h4>
								</div>										
								<form action="fungsi/tambah/tambah.php?barang=tambah" method="POST">
									<div class="modal-body">
										...
										<table class="table table-striped bordered">
											...
											<tr>
												<td>Nama Customer</td>
												<td><input type="text" placeholder="Masukkan Nama Customer" required class="form-control" name="nama"></td>
											</tr>
											<tr>
												<td>Nama Obat</td>
												<td><input type="text" placeholder="Masukkan Nama Obat" required class="form-control"  name="merk"></td>
											</tr>
											<tr>
												<td>Harga Dibayar</td>
												<td><input type="number" placeholder="Masukkan Harga Pembayaran" required class="form-control" name="beli"></td>
											</tr>
											<tr>
												<td>Harga Obat</td>
												<td><input type="number" placeholder="Masukkan Harga Obat" required class="form-control"  name="jual"></td>
											</tr>
											<tr>
												<td>Stok</td>
												<td>
													<select name="satuan" class="form-control" required>
														...
														<option value="PCS">Tersedia</option>
													</select>
												</td>
											</tr>
											<tr>
												<td>Sisa Stok</td>
												<td><input type="number" required Placeholder="Masukkan Jumlah Sisa Stok" class="form-control"  name="stok"></td>
											</tr>
											<tr>
												<td>Tanggal Input</td>
