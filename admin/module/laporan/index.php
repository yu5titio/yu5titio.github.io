                  ...
                  <div class="col-lg-12 main-chart">
						<h3>
							...
							<?php if(!empty($_GET['cari'])){ ?>
								Data Laporan  <?= $bulan_tes[$_POST['bln']];?> <?= $_POST['thn'];?>
							<?php }elseif(!empty($_GET['hari'])){?>
								Data Laporan  <?= $_POST['hari'];?>
							<?php }else{?>
								<b>Data Laporan  <?= $bulan_tes[date('m')];?> <?= date('Y');?></b>
							<?php }?>
						</h3>
						<br/>
							...
							<table class="table table-bordered" id="example1">
								<thead>
									<tr style="background:#DFF0D8;color:#333;">
										...
										<th style="width:10%;"> Harga Dibayar</th>
										<th style="width:10%;"> Satuan Harga</th>
										<th> Admin</th>
										<th> Tanggal Input</th>
									</tr>
								</thead>
