						...
						<div class="col-sm-4">
							<div class="panel panel-primary">
								<div class="panel-heading">
									<h4><i class="fa fa-search"></i> Cari Customer</h4>
								</div>
								<div class="panel-body">
									<input type="text" id="cari" class="form-control" name="cari" placeholder="Masukan : Kode / Nama Customer  [ENTER]">
								</div>
							</div>
						</div>
						<div class="col-sm-8">
											...
											if(!empty($_GET['nota'] == 'yes')) {
												...
												if(!empty($bayar))
												{
													...
													if($bayar >= $total)
													{
														...
														echo '<script>alert("Pembayaran Berhasil Di Bayar !");</script>';
													}else{
