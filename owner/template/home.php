                      ...
                      <!-- STATUS PANELS -->
                      	...
                      	<div class="col-md-5">
                      		<div class="panel panel-info">
                      			<div class="panel-heading">
						  			<h5><i class="fa fa-desktop"></i> Data Grafik</h5>
                      			</div>
                      			<div class="panel-body">
									<center><h1>G</h1></center>
								</div>
								<div class="panel-footer">
									<h4 style="font-size:15px;font-weight:700;font-weight:700;"><a href='owner/module/grafik/index.php'>Grafik Penjualan  <i class='fa fa-angle-double-right'></i></a></h4>
								</div>
	                      	</div><!--/grey-panel -->
                      	</div><!-- /col-md-3-->
					</div>
